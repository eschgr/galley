...
- **R44.** Bulk tab operations (close all / close others) — **out of scope** (see main PRD §3).
...
- **R52b. No new runtime dependencies** — printing and PDF export use Electron's built-in `webContents` APIs (supports the main PRD §6 self-contained goal).
...
- **Out of scope this version:** page numbers / running headers-footers, an in-app page-size or margin chooser, and opening the PDF after export (see main PRD §3 and §12).
